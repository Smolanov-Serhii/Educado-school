...
$popular_q = new WP_Query([
    ...
    // чтобы языковые плагины/фильтры не резали список
...
// 2) "Все статьи" — все записи блога (все языки) + пагинация
...
$all_posts_q = new WP_Query([
    ...
    // чтобы не дублировать "Популярно" внизу (если надо — убери)
    ...
    <section class="ed-blog">
        <div class="container">
            ...
            <div class="banner-world">
                <?php $banner_img = get_field('kartinka_dlya_bloku', 1084); ?>
                ...
                <div class="languages-ticker__wrapper">
                    <div class="languages-ticker__line">
                        <?php foreach ($terms as $term) :
                            ...
                            ?>
                            <a href="<?php echo esc_url($term_link); ?>" class="language">
                                ...
                                <div class="technology__title"><?php echo esc_html($term->name); ?></div>
                            </a>
                        <?php endforeach; ?>
                    </div>
                </div>
                        ...
                        <?php while ($popular_q->have_posts()) : $popular_q->the_post();
                            ...
                            <article <?php post_class('popular-post swiper-slide'); ?>>
                                ...
                                <h3 class="taxonomy-post__title banner-subtitle h3">
                                    <a href="<?php the_permalink(); ?>"><?php echo esc_html($title_to_show); ?></a>
                                </h3>

                                <div class="taxonomy-post__excerpt">
                                    <?php
                                    if (!empty($acf_excerpt)) echo wp_kses_post(wpautop($acf_excerpt));
                                    else the_excerpt();
                                    ?>
                                </div>
                            </article>
