...
?>
    ...
    <main class="taxonomy-language">
        ...
        $popular_q = new WP_Query([
            ...
            // чтобы блок "Популярные" не зависел от текущего архива языка и фильтров плагинов
            'suppress_filters'    => true,

            // исключаем уже показанные посты текущего языка (по желанию)
                    ...
                    <div class="popular-posts__list swiper-container">
                        ...
                        <?php while ($popular_q->have_posts()) : $popular_q->the_post(); ?>
                            <article <?php post_class('popular-post swiper-slide'); ?>>
                                ...
                                // Заголовок: если ACF пустой — берём обычный title
        ...
        <!-- ===== Посты текущего термина (основной вывод) ===== -->
        <?php if (have_posts()) : ?>
            <div class="taxonomy-posts">
                <div class="container">
                    <!-- ===== Заголовок текущего термина ===== -->
